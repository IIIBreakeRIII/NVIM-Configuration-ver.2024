...
require("presence").setup({
    ...
    editing_text        = "❤️ Secret Date w/ NVIM",               -- Format string rendered when an editable file is loaded in the buffer (either string or function(filename: string): string)
